view: data_eu {
  sql_table_name: `lookerdata.trump_effect_2017_01.data_EU`
    ;;
  ...
  dimension: _dem__ethnic_background {
    type: string
    sql: ${TABLE}._dem__ethnic_background ;;
  }
  ...
  dimension: _question__certainty_party_to_vote {
    type: string
    sql: ${TABLE}._question__certainty_party_to_vote ;;
  }
  ...
  dimension: _question__friends_family_same_vote {
    type: string
    sql: ${TABLE}._question__friends_family_same_vote ;;
  }
  ...
  dimension: _question__opinion_eu {
    type: string
    sql: ${TABLE}._question__opinion_eu ;;
  }

  dimension: _question_opinion_eu_normalized {
    type: string
    case: {
      when: {
        label: "positive"
        sql: ${_question__opinion_eu} = 'Very positive' OR ${_question__opinion_eu} = 'Somewhat positive' ;;
      }
      when: {
        label: "negative"
        sql: ${_question__opinion_eu} = 'Very negative' OR ${_question__opinion_eu} = 'Somewhat negative' ;;
      }
      else: "neither"
    }
  }
  ...
  dimension: _question__ranking_party_de {
    type: string
    sql: ${TABLE}._question__ranking_party_de ;;
  }

  dimension: _question__ranking_party_es {
    type: string
    sql: ${TABLE}._question__ranking_party_es ;;
  }

  dimension: _question__ranking_party_fr {
    type: string
    sql: ${TABLE}._question__ranking_party_fr ;;
  }

  dimension: _question__ranking_party_gb {
    type: string
    sql: ${TABLE}._question__ranking_party_gb ;;
  }

  dimension: _question__ranking_party_it {
    type: string
    sql: ${TABLE}._question__ranking_party_it ;;
  }

  dimension: _question__ranking_party_pl {
    type: string
    sql: ${TABLE}._question__ranking_party_pl ;;
  }
  ...
  dimension: _question__vote_nextelection_de {
    type: string
    sql: ${TABLE}._question__vote_nextelection_de ;;
  }

  dimension: _question__vote_nextelection_es {
    type: string
    sql: ${TABLE}._question__vote_nextelection_es ;;
  }

  dimension: _question__vote_nextelection_fr {
    type: string
    sql: ${TABLE}._question__vote_nextelection_fr ;;
  }

  dimension: _question__vote_nextelection_gb {
    type: string
    sql: ${TABLE}._question__vote_nextelection_gb ;;
  }

  dimension: _question__vote_nextelection_it {
    type: string
    sql: ${TABLE}._question__vote_nextelection_it ;;
  }

  dimension: _question__vote_nextelection_pl {
    type: string
    sql: ${TABLE}._question__vote_nextelection_pl ;;
  }

  dimension: _question__vote_referendum {
    type: string
    sql: ${TABLE}._question__vote_referendum ;;
  }

  dimension: _question__voted_party_last_election_de {
    type: string
    sql: ${TABLE}._question__voted_party_last_election_de ;;
  }

  dimension: _question__voted_party_last_election_es {
    type: string
    sql: ${TABLE}._question__voted_party_last_election_es ;;
  }

  dimension: _question__voted_party_last_election_fr {
    type: string
    sql: ${TABLE}._question__voted_party_last_election_fr ;;
  }

  dimension: _question__voted_party_last_election_gb {
    type: string
    sql: ${TABLE}._question__voted_party_last_election_gb ;;
  }

  dimension: _question__voted_party_last_election_it {
    type: string
    sql: ${TABLE}._question__voted_party_last_election_it ;;
  }

  dimension: _question__voted_party_last_election_pl {
    type: string
    sql: ${TABLE}._question__voted_party_last_election_pl ;;
  }

  dimension: _question__when_vote_decision_was_made {
    type: string
    sql: ${TABLE}._question__when_vote_decision_was_made ;;
  }
