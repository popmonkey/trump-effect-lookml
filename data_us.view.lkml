view: data_us {
  sql_table_name: `lookerdata.trump_effect_2017_01.data_US`
    ;;
  ...
  dimension: _question_opinion_government_normalized {
    type: string
    case: {
      when: {
        label: "positive"
        sql: ${_question__opinion_government} = 'Very positive' OR ${_question__opinion_government} = 'Somewhat positive' ;;
      }
      when: {
        label: "negative"
        sql: ${_question__opinion_government} = 'Very negative' OR ${_question__opinion_government} = 'Somewhat negative' ;;
      }
      else: "neither"
    }
  }
